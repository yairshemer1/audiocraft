...
class ComplexDenoiseCompressionSolver(CompressionSolver):
    ...
    def run_model(self, x, **kwargs):
        ...
        x, cond = self.preprocess(x_noisy)
        ...
        for idx, c in enumerate(cond):
            if c == 1:
                y.append(x_clean[idx])
            else:
                y.append(x_noisy[idx])
    ...
    def preprocess(self, x):
        ...
        unif = torch.ones(B) * self.denoise_params.prob
